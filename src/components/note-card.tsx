...
import { formatDistanceToNow } from "date-fns"; //usado para formatar datas
import { ptBR } from "date-fns/locale"; //usar a data em porugues
...
export function NoteCard({ note, onNoteDeleted }: NoteCardProps) {
  return (
    <Dialog.Root>
      ...
      {/*Trigger é usado no elemento onde o modal sera aberto*/}
